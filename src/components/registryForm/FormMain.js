...
function FormMain(props) {
  ...
  const { values, handleChange, nextStep, classes } = props;
  const { rateDayBs, rateDayUSD, firstName, lastName, identity, phoneNumber, email, paymentMethodType, company, position } = values;
